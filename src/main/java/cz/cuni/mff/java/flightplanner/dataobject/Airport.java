...
public class Airport {
     ...
     * character.
     *
     * @param searchCrit The message containing appropriate airport search
     ...
     *         for in the database.
     */
    private static @NotNull List<String> enterAirports(@Nullable String searchCrit) {
        ...
        do {
            ...
            System.out.print("You can search %CRIT: ".replace("%CRIT", searchCrit));
    ...
    public static List<Airport> searchAirports(@Nullable List<Airport> airportsList,
        ...
        String criterium = "by ICAO code (e.g. LKPR), by city name (Prague) or the airport name (e.g \"Havel\" for Prague airport)";
        if (onlyICAO) {
            System.out.println("Only 4-letter ICAO codes will be accepted.");
            criterium = "by ICAO code only";
        }
        ...
        if (predefinedApts == null) {
            ...
            List<String> aptsToSearch = enterAirports(criterium);
